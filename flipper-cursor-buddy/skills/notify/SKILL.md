---
name: flipper-notify
description: Send a custom sound, vibration, and text notification to the Flipper Zero via the flipper-cursor-buddy bridge daemon (requires the bridge to be running).
allowed-tools: Bash
---
